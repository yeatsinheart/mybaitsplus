...
public abstract class AbstractTemplateEngine {
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                // ReqDto.java
                if (null != tableInfo.getDtoName() && null != pathInfo.get(ConstVal.REQ_DTO_PATH)) {
                    String dtoFile = String.format((pathInfo.get(ConstVal.REQ_DTO_PATH) + File.separator + tableInfo.getReqDtoName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.REQDTO, dtoFile)) {
                        writer(objectMap, templateFilePath(template.getReqDto()), dtoFile);
                    }
                }
                // ResponseDto.java
                if (null != tableInfo.getDtoName() && null != pathInfo.get(ConstVal.RESPONSE_DTO_PATH)) {
                    String dtoFile = String.format((pathInfo.get(ConstVal.RESPONSE_DTO_PATH) + File.separator + tableInfo.getResponseDtoName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.RESPONSEDTO, dtoFile)) {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("reqDto", tableInfo.getReqDtoName());
        objectMap.put("responseDto", tableInfo.getResponseDtoName());
