...
*/
    ...
    @ApiModel(value="KkUserMoneyFlowDto对象", description="")
    public class KkUserMoneyFlowDto implements Serializable {
    ...
    private String changeType;
            ...
            @ApiModelProperty(value = "参考kk_user_flow_type_detail 05充值 06提款 01下注 02中奖 03反水 04撤单 10跟单赚佣金,11跟单付佣金,20活动彩金")
